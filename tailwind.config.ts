...
const config: Config = {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ["var(--font-yekan-bakh)", "Yekan Bakh FaNum", "Tahoma", "sans-serif"],
      },
      colors: {
        ...
        success: {
          ...
          bg: "hsl(var(--color-status-success-bg))",
        },
        warning: {
          DEFAULT: "hsl(var(--color-status-warning))",
          foreground: "hsl(var(--color-text-inverse))",
          bg: "hsl(var(--color-status-warning-bg))",
        },
        info: {
          DEFAULT: "hsl(var(--color-status-info))",
          foreground: "hsl(var(--color-text-inverse))",
          bg: "hsl(var(--color-status-info-bg))",
        },
