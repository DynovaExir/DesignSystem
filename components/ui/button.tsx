...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-body-md font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary-500 text-card hover:bg-primary-700 active:bg-primary-900",
        destructive:
          "bg-danger-500 text-card hover:bg-danger-700",
        outline:
          "border border-border-strong bg-transparent text-foreground hover:bg-neutral-100",
        secondary:
